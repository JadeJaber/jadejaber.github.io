...
A class may implement many interface but cannot inherit from many classes. This is the main difference between a fully abstract class with 100% of abstract methods and an interface.
